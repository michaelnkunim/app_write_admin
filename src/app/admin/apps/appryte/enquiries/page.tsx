...
export default function EnquiriesAdminPage() {
  ...
  return (
    <div className="w-full">
      ...
      {/* Search and filters */}
      <div className="background border p-4 rounded-lg shadow mb-6">
             ...
             <div className="absolute z-10 right-0 mt-2 w-48 background  rounded-md shadow-lg overflow-hidden">
                <div className="py-1">
                  ...
                  <button
                    ...
                    className={`block px-4 py-2 text-sm w-full text-left ${
                      statusFilter === 'new' ? 'bg-gray-100 dark:bg-gray-700' : ''
                    }`}
                  >
                    New
                  </button>
                  <button
                    ...
                    className={`block px-4 py-2 text-sm w-full text-left ${
                      statusFilter === 'read' ? 'bg-gray-100 dark:bg-gray-700' : ''
                    }`}
                  >
                    Read
                  </button>
                  <button
                    ...
                    className={`block px-4 py-2 text-sm w-full text-left ${
                      statusFilter === 'replied' ? 'bg-gray-100 dark:bg-gray-700' : ''
                    }`}
                  >
                    Replied
                  </button>
      ...
      {/* Enquiries table */}
      <div className="background border rounded-lg shadow overflow-hidden">
        <div className="overflow-x-auto">
          <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            <thead className="background">
              <tr>
                <th scope="col" className="px-6 py-3 text-left text-xs font-medium text uppercase tracking-wider">
                  <input
                    type="checkbox"
                    ...
                    className="h-4 w-4 text focus:ring-primary rounded"
                  />
                </th>
                <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-light uppercase tracking-wider">
                  Name
                </th>
                <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-light uppercase tracking-wider">
                  Email
            ...
            <tbody className="background divide-y divide-gray-200 dark:divide-gray-700">
              {loading ? (
                ...
                enquiries.map(enquiry => (
                  <tr key={enquiry.id} className="hover:bg-secondary">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm font-medium text-light">{enquiry.name}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-light">{enquiry.email}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-light">{enquiry.company || '-'}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-light">{enquiry.country || '-'}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-light">{formatDate(enquiry.createdAt)}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
      ...
      {showPreviewModal && selectedEnquiry && (
        <div className="fixed inset-0 bg-black/25 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="background rounded-lg max-w-2xl w-full max-h-[90vh] overflow-auto">
            <div className="p-6">
